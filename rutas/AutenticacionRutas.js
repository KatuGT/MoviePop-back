...
const {registroValidaciones} = require("../validaciones/registroValidaciones")
const {loginValidaciones} = require("../validaciones/loginValidaciones")
const {resultadoValidacion} = require("../validaciones/resultadoValidacion")
...
router.post(
  "/register", 
  registroValidaciones, resultadoValidacion,
  async (req, res) => {
